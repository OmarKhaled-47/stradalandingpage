...
export async function POST(request: Request) {
  try {
    const { fullName, phoneNumber, email, propertyarea, additionalInfo } =
      await request.json();
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px; background-color: #f9f9f9;">
          ...
          <table style="width: 100%; font-size: 16px;">
            ...
            <tr>
              <td style="padding: 8px;"><strong>property area:</strong></td>
              <td style="padding: 8px;">${propertyarea}</td>
            </tr>
            <tr>
          ...
          <p style="font-size: 14px; color: #888; text-align: center;">
            Strada Properties | <a href="mailto:info@strada-properties.com" style="color: #007bff; text-decoration: none;">info@strada-Properties.com</a>
          </p>
        </div>
      `,
    });
