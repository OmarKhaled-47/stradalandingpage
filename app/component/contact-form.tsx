...
//                 <textarea
//                   className="bg-gray-100 dark:bg-neutral-800 p-3 rounded-md w-full mb-4 text-gray-900 dark:text-white resize-none"
//                   id="additionalInfo"
//                   name="additionalInfo"
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <LabelInputContainer>
                ...
                <select
                  ...
                  onChange={handleInputChange}
                  className="bg-gray-100 dark:bg-neutral-800 p-3 rounded-md w-full text-gray-900 dark:text-white"
                  required
                >
                  <option value="">Select a property area</option>
